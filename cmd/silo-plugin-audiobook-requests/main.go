...
import (
	...
	"github.com/RXWatcher/silo-plugin-audiobook-requests/internal/embeddednzbget"
	"github.com/RXWatcher/silo-plugin-audiobook-requests/internal/event"
	"github.com/RXWatcher/silo-plugin-audiobook-requests/internal/httproutes"
	"github.com/RXWatcher/silo-plugin-audiobook-requests/internal/migrate"
	...
	pluginrt "github.com/RXWatcher/silo-plugin-audiobook-requests/internal/runtime"
	"github.com/RXWatcher/silo-plugin-audiobook-requests/internal/scheduler"
	"github.com/RXWatcher/silo-plugin-audiobook-requests/internal/server"
...
func main() {
	logger := hclog.New(&hclog.LoggerOptions{Name: "silo-plugin-audiobook-requests"})
